...
public class IntegerFieldTest {
  ...
  @Test
  public void shouldAddIntegerFieldIntoPropertiesMap() {
    when(field.getName()).thenReturn(FIELD_NAME);
    Map<String, Object> properties = new HashMap<>();

    integerField.addField(field, properties);
    ...
    assertThat(fieldProperties.get("format"), equalTo("int32"));
  }

  @Test
  public void shouldAddIntegerFieldFromFieldNameIntoPropertiesMap() {
    Map<String, Object> properties = new HashMap<>();

    integerField.addField(FIELD_NAME, properties);
  ...
  @Test
  public void shouldAddIntegerTypeIntoPropertiesMap() {
    Map<String, Object> properties = new HashMap<>();

    integerField.addType(properties);
    ...
    assertThat(properties.get("format"), equalTo("int32"));
  }
}
